...
package linear_proj_pkg;
    ...
    parameter int A_OUTER_DIMENSION = top_pkg::I_MATRIX_DIMENSION;
    parameter int B_OUTER_DIMENSION = top_pkg::W_MATRIX_DIMENSION;
    parameter int INNER_DIMENSION= top_pkg::INNER_MATRIX_DIMENSION;
    parameter int NUM_CORES_B    = 1;
    parameter int NUM_CORES_A    = top_pkg::LP_NUM_CORES_A;
