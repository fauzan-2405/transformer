...
module top_w_converter #(
    ...
    logic in_valid_r2b_v_d;
    logic in_valid_r2b_v_d2;
    logic true_in_valid_r2b_v;
    ...
    logic in_valid_r2b_h_d;
    logic in_valid_r2b_h_d2;
    logic true_in_valid_r2b_h;
    ...
    r2b_converter_h #(
        ...
        .NUM_CORES_H(NUM_CORES_B)
    ) r2b_converter_h_unit (
        .clk(aclk),
        .rst_n(aresetn),
        .en(en_r2b_h),
        .in_valid(true_in_valid_r2b_h),
    ...
    assign true_in_valid_r2b_v = in_valid_r2b_v_d || in_valid_r2b_v_d2;
    assign true_in_valid_r2b_h = in_valid_r2b_h_d || in_valid_r2b_h_d2;

    assign in_mat_en_wb     = (state_reg == STATE_CONV) || (state_reg == STATE_COMP);
    assign we_mat_en_wb     = (state_reg == STATE_CONV) || (state_reg == STATE_COMP);    
    ...
    always_ff @(posedge aclk) begin
        if (~aresetn) begin
            ...
            in_valid_r2b_v_d    <= in_valid_r2b_v;
            in_valid_r2b_v_d2   <= in_valid_r2b_v_d;
            in_valid_r2b_h_d    <= in_valid_r2b_h;
            in_valid_r2b_h_d2   <= in_valid_r2b_h_d;
            ...
            if (state_reg == STATE_FILL) begin
                ...
                if (in_mat_addrb_fill < A_OUTER_DIMENSION - 1) begin
                    in_mat_addrb_fill   <= in_mat_addrb_fill + 1;
                end
                if (we_mat_addrb_fill < INNER_DIMENSION - 1) begin
                ...
                if (sys_finish) begin
                    ...
                    // Address controller
                    in_mat_addrb_wb <= counter + (INNER_DIMENSION/BLOCK_SIZE)*counter_row;
                    we_mat_addrb_wb <= counter + (INNER_DIMENSION/BLOCK_SIZE)*counter_col;
                end
