...
module tb_axis_top_w_converter;
    ...
    localparam WIDTH_IN_A  = WIDTH_A * INNER_DIMENSION;
    localparam WIDTH_IN_B  = WIDTH_B * B_OUTER_DIMENSION;
    localparam WIDTH_OUT_C = WIDTH_OUT*CHUNK_SIZE*NUM_CORES_A*NUM_CORES_B;

    localparam NUM_A_WORDS = A_OUTER_DIMENSION;

    localparam NUM_B_WORDS = INNER_DIMENSION;
    ...
    initial begin
        $readmemh("matrix_A_row_cleaned.mem", mem_A);
        $readmemh("matrix_B_row_cleaned.mem", mem_B);
    end
    
    axis_top_w_converter #(
