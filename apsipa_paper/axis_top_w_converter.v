...
module axis_top_w_converter #(
    // Matrix Parameters
    parameter A_OUTER_DIMENSION = 32,
    parameter INNER_DIMENSION   = 32,
    parameter B_OUTER_DIMENSION = 32,

    // Elements Parameters 
    parameter WIDTH_A       = 8,
    parameter FRAC_WIDTH_A  = 0,
    parameter WIDTH_B       = 8,
    parameter FRAC_WIDTH_B  = 0,
    parameter WIDTH_OUT     = 8,
    parameter FRAC_WIDTH_OUT= 0,
